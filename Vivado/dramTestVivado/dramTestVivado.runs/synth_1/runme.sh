...
HD_PWD='D:/git/clash-moisc/Clash/tests/dramTestVivado/dramTestVivado.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log DramTest.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source DramTest.tcl
