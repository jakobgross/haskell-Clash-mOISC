...
HD_PWD='D:/git/clash-moisc/Clash/tests/dramTestVivado/dramTestVivado.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log DramTest.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source DramTest.tcl -notrace
