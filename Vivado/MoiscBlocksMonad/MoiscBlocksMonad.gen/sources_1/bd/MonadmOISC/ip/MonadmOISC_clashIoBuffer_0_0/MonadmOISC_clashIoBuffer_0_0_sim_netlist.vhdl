...
--               d:/git/clash-moisc/Vivado/MoiscBlocksMonad/MoiscBlocksMonad.gen/sources_1/bd/MonadmOISC/ip/MonadmOISC_clashIoBuffer_0_0/MonadmOISC_clashIoBuffer_0_0_sim_netlist.vhdl
-- Design      : MonadmOISC_clashIoBuffer_0_0
...
entity MonadmOISC_clashIoBuffer_0_0_IoBuffer is
  port (
  ...
  attribute ORIG_REF_NAME of MonadmOISC_clashIoBuffer_0_0_IoBuffer : entity is "IoBuffer";
end MonadmOISC_clashIoBuffer_0_0_IoBuffer;

architecture STRUCTURE of MonadmOISC_clashIoBuffer_0_0_IoBuffer is
  signal T : STD_LOGIC;
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity MonadmOISC_clashIoBuffer_0_0 is
  port (
    fsm_in : in STD_LOGIC_VECTOR ( 7 downto 0 );
    dir : in STD_LOGIC_VECTOR ( 7 downto 0 );
    outside_io : inout STD_LOGIC_VECTOR ( 7 downto 0 );
  ...
  attribute NotValidForBitStream of MonadmOISC_clashIoBuffer_0_0 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of MonadmOISC_clashIoBuffer_0_0 : entity is "MonadmOISC_clashIoBuffer_0_0,IoBuffer,{}";
  attribute downgradeipidentifiedwarnings : string;
  attribute downgradeipidentifiedwarnings of MonadmOISC_clashIoBuffer_0_0 : entity is "yes";
  attribute ip_definition_source : string;
  attribute ip_definition_source of MonadmOISC_clashIoBuffer_0_0 : entity is "package_project";
  attribute x_core_info : string;
  attribute x_core_info of MonadmOISC_clashIoBuffer_0_0 : entity is "IoBuffer,Vivado 2021.2.1";
end MonadmOISC_clashIoBuffer_0_0;

architecture STRUCTURE of MonadmOISC_clashIoBuffer_0_0 is
begin
U0: entity work.MonadmOISC_clashIoBuffer_0_0_IoBuffer
     port map (
