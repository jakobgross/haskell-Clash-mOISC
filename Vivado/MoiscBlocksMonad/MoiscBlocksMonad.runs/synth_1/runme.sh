...
HD_PWD='D:/git/clash-moisc/Vivado/MoiscBlocksMonad/MoiscBlocksMonad.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log MonadmOISC_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source MonadmOISC_wrapper.tcl
