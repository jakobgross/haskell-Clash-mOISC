...
HD_PWD='D:/git/clash-moisc/Vivado/FSM_Block_original/FSM_Block_original.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log dRISC_FSM.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source dRISC_FSM.tcl
