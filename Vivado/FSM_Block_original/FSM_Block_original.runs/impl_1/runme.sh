...
HD_PWD='D:/git/clash-moisc/Vivado/FSM_Block_original/FSM_Block_original.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log dRISC_FSM.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source dRISC_FSM.tcl -notrace
