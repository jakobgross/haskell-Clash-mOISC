...
HD_PWD='D:/git/clash-moisc/Vivado/referenceImplementationVivado/referenceImplementationVivado.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log dRISC.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source dRISC.tcl
