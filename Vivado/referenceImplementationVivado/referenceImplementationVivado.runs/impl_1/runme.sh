...
HD_PWD='D:/git/clash-moisc/Vivado/referenceImplementationVivado/referenceImplementationVivado.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log dRISC.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source dRISC.tcl -notrace
