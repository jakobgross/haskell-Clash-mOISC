...
#
# Generated by export_simulation on Tue Apr 26 16:42:42 +0200 2022
#
################################################################################
...
'-reset_run' switch to the './dRISC_PLL.sh' script.

./dRISC_PLL.sh -reset_run
...
./dRISC_PLL.sh -noclean_files

For more information on the script, please type './dRISC_PLL.sh -help'.
