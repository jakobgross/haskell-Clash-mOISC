...
entity dRISC_IOCONTROLLER is
	port(		
			CLK: in std_logic;
			RST: in std_logic;
			INTERRUPT_BLOCK: in std_logic := '1';
			IOR: in std_logic_vector(REG_WIDTH-1 downto 0) := (others => '0'); 
			IWR: in std_logic_vector(REG_WIDTH-1 downto 0) := (others => '0');
			ICR: in std_logic_vector(REG_WIDTH-1 downto 0) := (others => '0');
