...
set_property MARK_DEBUG true [get_nets {CSR[0]}]
set_property MARK_DEBUG true [get_nets {CSR[1]}]
set_property MARK_DEBUG true [get_nets {CSR[2]}]
set_property MARK_DEBUG true [get_nets {CSR[3]}]
set_property MARK_DEBUG true [get_nets {CSR[4]}]
set_property MARK_DEBUG true [get_nets {CSR[5]}]
set_property MARK_DEBUG true [get_nets {CSR[6]}]
set_property MARK_DEBUG true [get_nets {CSR[7]}]
set_property MARK_DEBUG true [get_nets {CMP[0]}]
set_property MARK_DEBUG true [get_nets {CMP[1]}]
set_property MARK_DEBUG true [get_nets {CMP[2]}]
set_property MARK_DEBUG true [get_nets {dataout[0]}]
set_property MARK_DEBUG true [get_nets {dataout[1]}]
set_property MARK_DEBUG true [get_nets {dataout[2]}]
set_property MARK_DEBUG true [get_nets {dataout[3]}]
set_property MARK_DEBUG true [get_nets {dataout[4]}]
set_property MARK_DEBUG true [get_nets {dataout[5]}]
set_property MARK_DEBUG true [get_nets {dataout[6]}]
set_property MARK_DEBUG true [get_nets {dataout[7]}]
set_property MARK_DEBUG true [get_nets {MEM_address[3]}]
set_property MARK_DEBUG true [get_nets {MEM_address[6]}]
set_property MARK_DEBUG true [get_nets {MEM_address[10]}]
set_property MARK_DEBUG true [get_nets {MEM_address[9]}]
set_property MARK_DEBUG true [get_nets {MEM_address[11]}]
set_property MARK_DEBUG true [get_nets {MEM_address[13]}]
set_property MARK_DEBUG true [get_nets {MEM_address[0]}]
set_property MARK_DEBUG true [get_nets {MEM_address[2]}]
set_property MARK_DEBUG true [get_nets {MEM_address[4]}]
set_property MARK_DEBUG true [get_nets {MEM_address[5]}]
set_property MARK_DEBUG true [get_nets {MEM_address[7]}]
set_property MARK_DEBUG true [get_nets {MEM_address[12]}]
set_property MARK_DEBUG true [get_nets {MEM_address[1]}]
set_property MARK_DEBUG true [get_nets {MEM_address[8]}]
set_property MARK_DEBUG true [get_nets {MEM_address[14]}]
set_property MARK_DEBUG true [get_nets {MEM_data[0]}]
set_property MARK_DEBUG true [get_nets {MEM_data[3]}]
set_property MARK_DEBUG true [get_nets {MEM_data[4]}]
set_property MARK_DEBUG true [get_nets {MEM_data[6]}]
set_property MARK_DEBUG true [get_nets {MEM_data[8]}]
set_property MARK_DEBUG true [get_nets {MEM_data[11]}]
set_property MARK_DEBUG true [get_nets {MEM_data[12]}]
set_property MARK_DEBUG true [get_nets {MEM_data[14]}]
set_property MARK_DEBUG true [get_nets {MEM_data[1]}]
set_property MARK_DEBUG true [get_nets {MEM_data[2]}]
set_property MARK_DEBUG true [get_nets {MEM_data[5]}]
set_property MARK_DEBUG true [get_nets {MEM_data[7]}]
set_property MARK_DEBUG true [get_nets {MEM_data[9]}]
set_property MARK_DEBUG true [get_nets {MEM_data[10]}]
set_property MARK_DEBUG true [get_nets {MEM_data[13]}]
set_property MARK_DEBUG true [get_nets {MEM_data[15]}]
...
connect_debug_port u_ila_0/clk [get_nets [list CLKuu0_BUFG]]
set_property PROBE_TYPE DATA_AND_TRIGGER [get_debug_ports u_ila_0/probe0]
set_property port_width 16 [get_debug_ports u_ila_0/probe0]
connect_debug_port u_ila_0/probe0 [get_nets [list {MEM_data[0]} {MEM_data[1]} {MEM_data[2]} {MEM_data[3]} {MEM_data[4]} {MEM_data[5]} {MEM_data[6]} {MEM_data[7]} {MEM_data[8]} {MEM_data[9]} {MEM_data[10]} {MEM_data[11]} {MEM_data[12]} {MEM_data[13]} {MEM_data[14]} {MEM_data[15]}]]
create_debug_port u_ila_0 probe
set_property PROBE_TYPE DATA_AND_TRIGGER [get_debug_ports u_ila_0/probe1]
set_property port_width 3 [get_debug_ports u_ila_0/probe1]
connect_debug_port u_ila_0/probe1 [get_nets [list {CMP[0]} {CMP[1]} {CMP[2]}]]
create_debug_port u_ila_0 probe
set_property PROBE_TYPE DATA_AND_TRIGGER [get_debug_ports u_ila_0/probe2]
set_property port_width 15 [get_debug_ports u_ila_0/probe2]
connect_debug_port u_ila_0/probe2 [get_nets [list {MEM_address[0]} {MEM_address[1]} {MEM_address[2]} {MEM_address[3]} {MEM_address[4]} {MEM_address[5]} {MEM_address[6]} {MEM_address[7]} {MEM_address[8]} {MEM_address[9]} {MEM_address[10]} {MEM_address[11]} {MEM_address[12]} {MEM_address[13]} {MEM_address[14]}]]
create_debug_port u_ila_0 probe
set_property PROBE_TYPE DATA_AND_TRIGGER [get_debug_ports u_ila_0/probe3]
set_property port_width 8 [get_debug_ports u_ila_0/probe3]
connect_debug_port u_ila_0/probe3 [get_nets [list {CSR[0]} {CSR[1]} {CSR[2]} {CSR[3]} {CSR[4]} {CSR[5]} {CSR[6]} {CSR[7]}]]
create_debug_port u_ila_0 probe
set_property PROBE_TYPE DATA_AND_TRIGGER [get_debug_ports u_ila_0/probe4]
set_property port_width 8 [get_debug_ports u_ila_0/probe4]
connect_debug_port u_ila_0/probe4 [get_nets [list {dataout[0]} {dataout[1]} {dataout[2]} {dataout[3]} {dataout[4]} {dataout[5]} {dataout[6]} {dataout[7]}]]
set_property C_CLK_INPUT_FREQ_HZ 300000000 [get_debug_cores dbg_hub]
set_property C_ENABLE_CLK_DIVIDER false [get_debug_cores dbg_hub]
set_property C_USER_SCAN_CHAIN 1 [get_debug_cores dbg_hub]
connect_debug_port dbg_hub/clk [get_nets CLKuu0_BUFG]
