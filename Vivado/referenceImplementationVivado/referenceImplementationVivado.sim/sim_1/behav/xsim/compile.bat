...
REM
REM Generated by Vivado on Mon May 16 21:38:37 +0200 2022
...
echo "xvhdl --incr --relax -prj dRISC_vhdl.prj"
call xvhdl  --incr --relax -prj dRISC_vhdl.prj -log xvhdl.log
