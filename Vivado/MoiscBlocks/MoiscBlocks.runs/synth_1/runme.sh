...
HD_PWD='D:/git/clash-moisc/Vivado/MoiscBlocks/MoiscBlocks.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mOISC_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mOISC_wrapper.tcl
