...
signal CPU_STOPu: std_logic := '1';
signal INTERRUPT_BLOCKu: std_logic := '0';
signal DETECT_PREV: std_logic_vector(REG_WIDTH-1 downto 0) := (others => '0');
signal DETECT_PREVu: std_logic_vector(REG_WIDTH-1 downto 0) := (others => '0');
