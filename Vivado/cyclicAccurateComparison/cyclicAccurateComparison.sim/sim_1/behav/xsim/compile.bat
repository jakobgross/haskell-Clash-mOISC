...
REM
REM Generated by Vivado on Sat Aug 20 10:21:00 +0200 2022
...
echo "xvhdl --incr --relax -prj tb_compare_vhdl.prj"
call xvhdl  --incr --relax -prj tb_compare_vhdl.prj -log xvhdl.log
