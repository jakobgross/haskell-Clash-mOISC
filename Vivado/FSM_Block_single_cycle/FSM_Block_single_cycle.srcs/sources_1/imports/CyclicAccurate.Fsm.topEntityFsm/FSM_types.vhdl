...
package FSM_types is
  ...
  type tup3 is record
    tup3_sel0_fsmstate : fsmstate;
    tup3_sel1_fsmregisters : fsmregisters;
    tup3_sel2_fsm2alu : fsm2alu;
  end record;
...
package body FSM_types is
  ...
  begin
    return (toSLV(p.tup3_sel0_fsmstate) & toSLV(p.tup3_sel1_fsmregisters) & toSLV(p.tup3_sel2_fsm2alu));
  end;
